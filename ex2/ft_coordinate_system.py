...
def main():
    ...
    print(f"It includes: X={firs_coord[0]}, Y={firs_coord[1]}, Z={firs_coord[2]}")
    print("Distance to the center:", distance_from_center(firs_coord))
    print("\n")
    print("Get a second set of coordinates")
    second_coord = get_player_pos()
    print("Distance between the 2 set of coordinates:", distance_between_point(firs_coord, second_coord))

...
#                                                 +#+#+#+#+#+   +#+            #
#    Created: 2026/08/24 09:46:24 by ealiman           #+#    #+#              #
#    Updated: 2026/08/24 13:35:58 by ealiman          ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
def consume_event(list_event: list) -> typing.Generator[tuple[str, str], None, None]:
    while list_event:
